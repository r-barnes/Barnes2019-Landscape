#ifndef _fastscape_rb_gpu_graph_hpp_
#define _fastscape_rb_gpu_graph_hpp_
...
class FastScape_RBGPUgraph {
 ...
 private:
  ...
  bool   *graph_mask;          //Cells on the frontier of the graph
  bool   *graph_updating_mask; //Cells that will be on the frontier of the graph
  bool   *graph_visited;       //Cells that have already been visited
 ...
 public:
  ///Initializing code
  FastScape_RBGPUgraph(const int width0, const int height0);

  ~FastScape_RBGPUgraph();
