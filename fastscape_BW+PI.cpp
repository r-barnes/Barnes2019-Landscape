...
///Initializing code
FastScape_BWPI::FastScape_BWPI(const int width0, const int height0)
...
void FastScape_BWPI::ComputeReceivers(){
...
void FastScape_BWPI::ComputeDonors(){
...
void FastScape_BWPI::FindStack(const int c, int &nstack){
...
///such an order.
void FastScape_BWPI::GenerateOrder(){
...
void FastScape_BWPI::ComputeFlowAcc(){
...
///appropriately.
void FastScape_BWPI::run(const int nstep){
  Tmr_Overall.start();
